...
public final class SctpChannelOption {
   ...
   static {
      SCTP_DISABLE_FRAGMENTS = ChannelOption.valueOf(T, "SCTP_DISABLE_FRAGMENTS");
      SCTP_EXPLICIT_COMPLETE = ChannelOption.valueOf(T, "SCTP_EXPLICIT_COMPLETE");
      SCTP_FRAGMENT_INTERLEAVE = ChannelOption.valueOf(T, "SCTP_FRAGMENT_INTERLEAVE");
      SCTP_INIT_MAXSTREAMS = ChannelOption.valueOf(T, "SCTP_INIT_MAXSTREAMS");
      SCTP_NODELAY = ChannelOption.valueOf(T, "SCTP_NODELAY");
      SCTP_PRIMARY_ADDR = ChannelOption.valueOf(T, "SCTP_PRIMARY_ADDR");
      SCTP_SET_PEER_PRIMARY_ADDR = ChannelOption.valueOf(T, "SCTP_SET_PEER_PRIMARY_ADDR");
   }
}
