...
public class OioSctpServerChannel extends AbstractOioMessageChannel implements SctpServerChannel {
   ...
   protected int doReadMessages(List<Object> buf) throws Exception {
      if (!this.isActive()) {
         ...
         try {
            ...
            if (selectedKeys > 0) {
               Iterator selectionKeys = this.selector.selectedKeys().iterator();
   ...
   private final class OioSctpServerChannelConfig extends DefaultSctpServerChannelConfig {
      ...
      // $FF: synthetic method
      OioSctpServerChannelConfig(OioSctpServerChannel x1, com.sun.nio.sctp.SctpServerChannel x2, Object x3) {
         this(x1, x2);
      }
   }
}
