...
public final class UdtChannelOption {
   ...
   static {
      PROTOCOL_RECEIVE_BUFFER_SIZE = ChannelOption.valueOf(T, "PROTOCOL_RECEIVE_BUFFER_SIZE");
      PROTOCOL_SEND_BUFFER_SIZE = ChannelOption.valueOf(T, "PROTOCOL_SEND_BUFFER_SIZE");
      SYSTEM_RECEIVE_BUFFER_SIZE = ChannelOption.valueOf(T, "SYSTEM_RECEIVE_BUFFER_SIZE");
      SYSTEM_SEND_BUFFER_SIZE = ChannelOption.valueOf(T, "SYSTEM_SEND_BUFFER_SIZE");
   }
}
