...
public interface ChannelPipeline extends Iterable<Entry<String, ChannelHandler>> {
   ...
   ChannelPipeline addFirst(ChannelHandlerInvoker var1, String var2, ChannelHandler var3);
   ...
   ChannelPipeline addLast(ChannelHandlerInvoker var1, String var2, ChannelHandler var3);
   ...
   ChannelPipeline addBefore(ChannelHandlerInvoker var1, String var2, String var3, ChannelHandler var4);
   ...
   ChannelPipeline addAfter(ChannelHandlerInvoker var1, String var2, String var3, ChannelHandler var4);

   ChannelPipeline addFirst(ChannelHandler... var1);

   ChannelPipeline addFirst(EventExecutorGroup var1, ChannelHandler... var2);

   ChannelPipeline addFirst(ChannelHandlerInvoker var1, ChannelHandler... var2);

   ChannelPipeline addLast(ChannelHandler... var1);

   ChannelPipeline addLast(EventExecutorGroup var1, ChannelHandler... var2);

   ChannelPipeline addLast(ChannelHandlerInvoker var1, ChannelHandler... var2);
