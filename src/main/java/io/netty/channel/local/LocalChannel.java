...
public class LocalChannel extends AbstractChannel {
   ...
   protected void doRegister() throws Exception {
      ...
      ((SingleThreadEventLoop)this.eventLoop().unwrap()).addShutdownHook(this.shutdownHook);
   }
   ...
   protected void doClose() throws Exception {
      if (this.state != LocalChannel.State.CLOSED) {
   ...
   protected void doDeregister() throws Exception {
      ((SingleThreadEventLoop)this.eventLoop().unwrap()).removeShutdownHook(this.shutdownHook);
   }
