...
public class CompositeByteBuf extends AbstractReferenceCountedByteBuf {
   ...
   private int addComponents0(int cIndex, Iterable<ByteBuf> buffers) {
      if (buffers == null) {
         ...
         if (!(buffers instanceof Collection)) {
            ...
            Iterator i$ = ((Iterable)buffers).iterator();
   ...
   public CompositeByteBuf removeComponents(int cIndex, int numComponents) {
      ...
      if (numComponents == 0) {
         ...
         CompositeByteBuf.Component c;
         for(Iterator i$ = toRemove.iterator(); i$.hasNext(); c.freeIfNecessary()) {
            c = (CompositeByteBuf.Component)i$.next();
            if (c.length > 0) {
               needsUpdate = true;
            }
         }
   ...
   public Iterator<ByteBuf> iterator() {
      ...
      while(i$.hasNext()) {
         CompositeByteBuf.Component c = (CompositeByteBuf.Component)i$.next();
         list.add(c.buf);
      }
   ...
   public CompositeByteBuf discardReadComponents() {
      ...
      if (readerIndex == 0) {
         ...
         CompositeByteBuf.Component first;
         if (readerIndex == writerIndex && writerIndex == this.capacity()) {
            Iterator i$ = this.components.iterator();

            while(i$.hasNext()) {
               first = (CompositeByteBuf.Component)i$.next();
            ...
            first = (CompositeByteBuf.Component)this.components.get(0);
   ...
   public CompositeByteBuf discardReadBytes() {
      ...
      if (readerIndex == 0) {
         ...
         if (readerIndex == writerIndex && writerIndex == this.capacity()) {
            ...
            this.components.subList(0, firstComponentId).clear();
            c = (CompositeByteBuf.Component)this.components.get(0);
