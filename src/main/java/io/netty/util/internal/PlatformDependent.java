...
public final class PlatformDependent {
   ...
   public static boolean isRoot() {
      if (IS_ROOT == null) {
         Class var0 = PlatformDependent.class;
   ...
   private static boolean isRoot0() {
      if (isWindows()) {
         ...
         String[] ID_COMMANDS = new String[]{"/usr/bin/id", "/bin/id", "/usr/xpg4/bin/id", "id"};
         Pattern UID_PATTERN = Pattern.compile("^(?:0|[1-9][0-9]*)$");
         String[] arr$ = ID_COMMANDS;
         int i = ID_COMMANDS.length;
         ...
         while(true) {
            if (i > 0) {
               ...
               try {
                  ...
                  String message = var44.getMessage();
                  if (message == null) {
                     message = "";
                  }
   ...
   private static long maxDirectMemory0() {
      ...
      try {
         mgmtFactoryClass = Class.forName("sun.misc.VM", true, getSystemClassLoader());
      ...
      if (maxDirectMemory > 0L) {
         ...
         try {
            mgmtFactoryClass = Class.forName("java.lang.management.ManagementFactory", true, getSystemClassLoader());
