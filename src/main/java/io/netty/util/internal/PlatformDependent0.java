...
final class PlatformDependent0 {
   ...
   static short getShort(long address) {
      if (UNALIGNED) {
         ...
         return BIG_ENDIAN ? (short)(getByte(address) << 8 | getByte(address + 1L) & 255) : (short)(getByte(address + 1L) << 8 | getByte(address) & 255);
      }
   }
   ...
   static int getInt(long address) {
      if (UNALIGNED) {
         ...
         return BIG_ENDIAN ? getByte(address) << 24 | (getByte(address + 1L) & 255) << 16 | (getByte(address + 2L) & 255) << 8 | getByte(address + 3L) & 255 : getByte(address + 3L) << 24 | (getByte(address + 2L) & 255) << 16 | (getByte(address + 1L) & 255) << 8 | getByte(address) & 255;
      }
   }
   ...
   static long getLong(long address) {
      if (UNALIGNED) {
         ...
         return BIG_ENDIAN ? (long)getByte(address) << 56 | ((long)getByte(address + 1L) & 255L) << 48 | ((long)getByte(address + 2L) & 255L) << 40 | ((long)getByte(address + 3L) & 255L) << 32 | ((long)getByte(address + 4L) & 255L) << 24 | ((long)getByte(address + 5L) & 255L) << 16 | ((long)getByte(address + 6L) & 255L) << 8 | (long)getByte(address + 7L) & 255L : (long)getByte(address + 7L) << 56 | ((long)getByte(address + 6L) & 255L) << 48 | ((long)getByte(address + 5L) & 255L) << 40 | ((long)getByte(address + 4L) & 255L) << 32 | ((long)getByte(address + 3L) & 255L) << 24 | ((long)getByte(address + 2L) & 255L) << 16 | ((long)getByte(address + 1L) & 255L) << 8 | (long)getByte(address) & 255L;
      }
   }
   ...
   static {
      ...
      if (unsafe == null) {
         ...
         try {
            ...
            unaligned = Boolean.TRUE.equals(unalignedMethod.invoke((Object)null));
