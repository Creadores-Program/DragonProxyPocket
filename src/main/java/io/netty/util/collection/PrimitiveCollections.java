...
public final class PrimitiveCollections {
   private static final IntObjectMap<Object> EMPTY_INT_OBJECT_MAP = new PrimitiveCollections.EmptyIntObjectMap();
   ...
   public static <V> IntObjectMap<V> unmodifiableIntObjectMap(IntObjectMap<V> map) {
      return new PrimitiveCollections.UnmodifiableIntObjectMap(map);
   }

   private static final class UnmodifiableIntObjectMap<V> implements IntObjectMap<V>, Iterable<IntObjectMap.Entry<V>> {
      ...
      public Iterator<IntObjectMap.Entry<V>> iterator() {
         return new PrimitiveCollections.UnmodifiableIntObjectMap.IteratorImpl(this.map.entries().iterator());
      }
      ...
      private class EntryImpl implements IntObjectMap.Entry<V> {
      ...
      private class IteratorImpl implements Iterator<IntObjectMap.Entry<V>> {
         ...
         public IntObjectMap.Entry<V> next() {
            if (!this.hasNext()) {
               ...
               return UnmodifiableIntObjectMap.this.new EntryImpl((IntObjectMap.Entry)this.iter.next());
            }
         }
