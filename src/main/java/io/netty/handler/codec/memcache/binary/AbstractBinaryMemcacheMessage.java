...
public abstract class AbstractBinaryMemcacheMessage extends AbstractMemcacheObject implements BinaryMemcacheMessage {
   ...
   public int refCnt() {
      return this.extras != null ? this.extras.refCnt() : 1;
   }
   ...
   public boolean release() {
      return this.extras != null ? this.extras.release() : false;
   }

   public boolean release(int decrement) {
      return this.extras != null ? this.extras.release(decrement) : false;
   }
