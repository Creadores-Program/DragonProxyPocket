...
public final class DnsResponseCode implements Comparable<DnsResponseCode> {
   ...
   public static DnsResponseCode valueOf(int responseCode) {
      ...
      case 14:
         return BADTIME;
      default:
         return new DnsResponseCode(responseCode, (String)null);
      }
   }
   ...
   public boolean equals(Object o) {
      if (!(o instanceof DnsResponseCode)) {
         ...
         return this.code() == ((DnsResponseCode)o).code();
      }
   }

   public String toString() {
      return this.message == null ? "DnsResponseCode(" + this.errorCode + ')' : "DnsResponseCode(" + this.errorCode + ", " + this.message + ')';
   }
}
