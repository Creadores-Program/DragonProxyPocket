...
public final class DnsType implements Comparable<DnsType> {
   ...
   public static DnsType valueOf(int intValue) {
      ...
      return result == null ? new DnsType(intValue, "UNKNOWN") : result;
   }
   ...
   static {
      DnsType[] all = new DnsType[]{A, NS, CNAME, SOA, PTR, MX, TXT, RP, AFSDB, SIG, KEY, AAAA, LOC, SRV, NAPTR, KX, CERT, DNAME, OPT, APL, DS, SSHFP, IPSECKEY, RRSIG, NSEC, DNSKEY, DHCID, NSEC3, NSEC3PARAM, TLSA, HIP, SPF, TKEY, TSIG, IXFR, AXFR, ANY, CAA, TA, DLV};
