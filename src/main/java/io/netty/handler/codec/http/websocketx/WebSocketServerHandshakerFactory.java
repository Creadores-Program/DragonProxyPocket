...
public class WebSocketServerHandshakerFactory {
   ...
   public WebSocketServerHandshaker newHandshaker(HttpRequest req) {
      CharSequence version = (CharSequence)req.headers().get(HttpHeaderNames.SEC_WEBSOCKET_VERSION);
      if (version != null) {
   ...
   public static ChannelFuture sendUnsupportedVersionResponse(Channel channel, ChannelPromise promise) {
      ...
      res.headers().set(HttpHeaderNames.SEC_WEBSOCKET_VERSION, (CharSequence)WebSocketVersion.V13.toHttpHeaderValue());
