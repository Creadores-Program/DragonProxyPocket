...
public class WebSocketServerHandshaker07 extends WebSocketServerHandshaker {
   ...
   protected FullHttpResponse newHandshakeResponse(FullHttpRequest req, HttpHeaders headers) {
      ...
      if (key == null) {
         ...
         res.headers().add(HttpHeaderNames.UPGRADE, (CharSequence)HttpHeaderValues.WEBSOCKET);
         res.headers().add(HttpHeaderNames.CONNECTION, (CharSequence)HttpHeaderValues.UPGRADE);
         res.headers().add(HttpHeaderNames.SEC_WEBSOCKET_ACCEPT, (CharSequence)accept);
