...
public class DefaultLastHttpContent extends DefaultHttpContent implements LastHttpContent {
   ...
   public DefaultLastHttpContent(ByteBuf content, boolean validateHeaders) {
      super(content);
      this.trailingHeaders = new DefaultLastHttpContent.TrailingHttpHeaders(validateHeaders);
   ...
   private static final class TrailingHttpHeaders extends DefaultHttpHeaders {
      private static final DefaultLastHttpContent.TrailingHttpHeaders.TrailingHttpHeadersNameConverter VALIDATE_NAME_CONVERTER = new DefaultLastHttpContent.TrailingHttpHeaders.TrailingHttpHeadersNameConverter(true);
      private static final DefaultLastHttpContent.TrailingHttpHeaders.TrailingHttpHeadersNameConverter NO_VALIDATE_NAME_CONVERTER = new DefaultLastHttpContent.TrailingHttpHeaders.TrailingHttpHeadersNameConverter(false);
