...
public class WebSocketClientHandshaker13 extends WebSocketClientHandshaker {
   ...
   protected FullHttpRequest newHandshakeRequest() {
      ...
      headers.add(HttpHeaderNames.UPGRADE, (CharSequence)HttpHeaderValues.WEBSOCKET).add(HttpHeaderNames.CONNECTION, (CharSequence)HttpHeaderValues.UPGRADE).add(HttpHeaderNames.SEC_WEBSOCKET_KEY, (CharSequence)key).add(HttpHeaderNames.HOST, (CharSequence)(wsURL.getHost() + ':' + wsPort));
      String originValue = "http://" + wsURL.getHost();
      if (wsPort != 80 && wsPort != 443) {
         originValue = originValue + ':' + wsPort;
      }

      headers.add(HttpHeaderNames.SEC_WEBSOCKET_ORIGIN, (CharSequence)originValue);
      ...
      headers.add(HttpHeaderNames.SEC_WEBSOCKET_VERSION, (CharSequence)"13");
