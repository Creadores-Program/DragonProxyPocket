...
public class HttpResponseStatus implements Comparable<HttpResponseStatus> {
   ...
   public static HttpResponseStatus parseLine(CharSequence line) {
      ...
      try {
         ...
         if (space == -1) {
            ...
            return responseStatus.reasonPhrase().toString().equals(reasonPhrase) ? responseStatus : new HttpResponseStatus(code, reasonPhrase);
         }
   ...
   public HttpStatusClass codeClass() {
      ...
      if (codeClass == null) {
         this.codeClass = codeClass = HttpStatusClass.valueOf(this.code);
      }
