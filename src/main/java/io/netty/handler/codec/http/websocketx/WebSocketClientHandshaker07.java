...
public class WebSocketClientHandshaker07 extends WebSocketClientHandshaker {
   ...
   protected FullHttpRequest newHandshakeRequest() {
      ...
      headers.add(HttpHeaderNames.UPGRADE, (CharSequence)HttpHeaderValues.WEBSOCKET).add(HttpHeaderNames.CONNECTION, (CharSequence)HttpHeaderValues.UPGRADE).add(HttpHeaderNames.SEC_WEBSOCKET_KEY, (CharSequence)key).add(HttpHeaderNames.HOST, (CharSequence)wsURL.getHost());
      ...
      headers.add(HttpHeaderNames.SEC_WEBSOCKET_VERSION, (CharSequence)"7");
