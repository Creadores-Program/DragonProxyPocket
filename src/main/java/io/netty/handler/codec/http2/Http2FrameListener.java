...
public interface Http2FrameListener {
   ...
   void onPingRead(ChannelHandlerContext var1, ByteBuf var2) throws Http2Exception;

   void onPingAckRead(ChannelHandlerContext var1, ByteBuf var2) throws Http2Exception;
   ...
   void onUnknownFrame(ChannelHandlerContext var1, byte var2, int var3, Http2Flags var4, ByteBuf var5);
}
