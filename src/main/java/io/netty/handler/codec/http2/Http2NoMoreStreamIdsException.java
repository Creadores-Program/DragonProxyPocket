...
public class Http2NoMoreStreamIdsException extends Http2Exception {
   ...
   public Http2NoMoreStreamIdsException() {
      super(Http2Error.PROTOCOL_ERROR, "No more streams can be created on this connection");
   }

   public Http2NoMoreStreamIdsException(Throwable cause) {
      super(Http2Error.PROTOCOL_ERROR, "No more streams can be created on this connection", cause);
   }
}
