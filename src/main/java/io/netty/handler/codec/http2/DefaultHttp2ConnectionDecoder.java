...
public class DefaultHttp2ConnectionDecoder implements Http2ConnectionDecoder {
   private final Http2FrameListener internalFrameListener = new DefaultHttp2ConnectionDecoder.FrameReadListener();
   ...
   public static DefaultHttp2ConnectionDecoder.Builder newBuilder() {
      return new DefaultHttp2ConnectionDecoder.Builder();
   }
   ...
   public Http2Settings localSettings() {
      ...
      settings.maxConcurrentStreams((long)this.connection.remote().maxStreams());
   ...
   public void localSettings(Http2Settings settings) throws Http2Exception {
      ...
      if (maxConcurrentStreams != null) {
         int value = (int)Math.min(maxConcurrentStreams, 2147483647L);
   ...
   private final class FrameReadListener implements Http2FrameListener {
      ...
      public int onDataRead(ChannelHandlerContext ctx, int streamId, ByteBuf data, int padding, boolean endOfStream) throws Http2Exception {
         ...
         boolean shouldIgnore = this.shouldIgnoreFrame(stream, false);
         ...
         try {
            ...
            try {
               ...
               delta = unconsumedBytes - DefaultHttp2ConnectionDecoder.this.unconsumedBytes(stream);
               bytesToReturn -= delta;
               throw var18;
      ...
      private void verifyGoAwayNotReceived() throws Http2Exception {
         if (DefaultHttp2ConnectionDecoder.this.connection.goAwayReceived()) {
            throw Http2Exception.connectionError(Http2Error.PROTOCOL_ERROR, "Received frames after receiving GO_AWAY");
         }
      }
   ...
   public static class Builder implements Http2ConnectionDecoder.Builder {
      ...
      public DefaultHttp2ConnectionDecoder.Builder lifecycleManager(Http2LifecycleManager lifecycleManager) {
      ...
      public DefaultHttp2ConnectionDecoder.Builder frameReader(Http2FrameReader frameReader) {
         this.frameReader = frameReader;
         return this;
      }

      public DefaultHttp2ConnectionDecoder.Builder listener(Http2FrameListener listener) {
         this.listener = listener;
         return this;
      }

      public DefaultHttp2ConnectionDecoder.Builder encoder(Http2ConnectionEncoder encoder) {
