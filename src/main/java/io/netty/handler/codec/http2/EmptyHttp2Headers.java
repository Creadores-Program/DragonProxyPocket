...
public final class EmptyHttp2Headers extends EmptyBinaryHeaders implements Http2Headers {
   ...
   public AsciiString method() {
      return (AsciiString)this.get(Http2Headers.PseudoHeaderName.METHOD.value());
   }

   public AsciiString scheme() {
      return (AsciiString)this.get(Http2Headers.PseudoHeaderName.SCHEME.value());
   }

   public AsciiString authority() {
      return (AsciiString)this.get(Http2Headers.PseudoHeaderName.AUTHORITY.value());
   }

   public AsciiString path() {
      return (AsciiString)this.get(Http2Headers.PseudoHeaderName.PATH.value());
   }

   public AsciiString status() {
      return (AsciiString)this.get(Http2Headers.PseudoHeaderName.STATUS.value());
   }
}
