...
public class JSONObject implements Serializable {
   ...
   public JSONObject(Map map) {
      ...
      Iterator i$ = this.myHashMap.keySet().iterator();

      while(i$.hasNext()) {
         Object k = i$.next();
         Object v = this.myHashMap.get(k);
         if (v instanceof Collection) {
            this.myHashMap.put(k, new JSONArray((Collection)v));
         }

         if (v instanceof Map) {
            this.myHashMap.put(k, new JSONObject((Map)v));
         }
      }
   ...
   public boolean equals(Object obj) {
      return obj instanceof JSONObject ? this.myHashMap.equals(((JSONObject)obj).myHashMap) : false;
   }
