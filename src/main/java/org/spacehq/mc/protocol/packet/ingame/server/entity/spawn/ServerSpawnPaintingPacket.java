...
public class ServerSpawnPaintingPacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      ...
      this.direction = (HangingDirection)MagicValues.key(HangingDirection.class, in.readUnsignedByte());
   }
   ...
   public void write(NetOutput out) throws IOException {
      ...
      out.writeByte((Integer)MagicValues.value(Integer.class, this.direction));
   }
