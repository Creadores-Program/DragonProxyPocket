...
public class ServerRespawnPacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      ...
      this.difficulty = (Difficulty)MagicValues.key(Difficulty.class, in.readUnsignedByte());
      this.gamemode = (GameMode)MagicValues.key(GameMode.class, in.readUnsignedByte());
      this.worldType = (WorldType)MagicValues.key(WorldType.class, in.readString().toLowerCase());
   }

   public void write(NetOutput out) throws IOException {
      out.writeInt(this.dimension);
      out.writeByte((Integer)MagicValues.value(Integer.class, this.difficulty));
      out.writeByte((Integer)MagicValues.value(Integer.class, this.gamemode));
