...
public class StatusResponsePacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      JsonObject obj = (JsonObject)(new Gson()).fromJson(in.readString(), JsonObject.class);
   ...
   public void write(NetOutput out) throws IOException {
      ...
      if (this.info.getPlayerInfo().getPlayers().length > 0) {
         ...
         GameProfile[] var6 = this.info.getPlayerInfo().getPlayers();
         int var7 = var6.length;

         for(int var8 = 0; var8 < var7; ++var8) {
            GameProfile profile = var6[var8];
