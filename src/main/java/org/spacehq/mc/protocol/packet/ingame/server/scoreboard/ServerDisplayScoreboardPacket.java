...
public class ServerDisplayScoreboardPacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      this.position = (ScoreboardPosition)MagicValues.key(ScoreboardPosition.class, in.readByte());
      this.name = in.readString();
   }

   public void write(NetOutput out) throws IOException {
      out.writeByte((Integer)MagicValues.value(Integer.class, this.position));
