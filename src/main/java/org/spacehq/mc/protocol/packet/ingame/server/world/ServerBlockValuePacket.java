...
public class ServerBlockValuePacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      ...
      if (this.blockId == 25) {
         this.type = (BlockValueType)MagicValues.key(NoteBlockValueType.class, type);
      } else if (this.blockId != 29 && this.blockId != 33) {
         if (this.blockId == 52) {
            this.type = (BlockValueType)MagicValues.key(MobSpawnerValueType.class, type);
         } else if (this.blockId != 54 && this.blockId != 130 && this.blockId != 146) {
            this.type = (BlockValueType)MagicValues.key(GenericBlockValueType.class, type);
         } else {
            this.type = (BlockValueType)MagicValues.key(ChestValueType.class, type);
         }
      } else {
         this.type = (BlockValueType)MagicValues.key(PistonValueType.class, type);
      }
      ...
      if (this.blockId == 25) {
         ...
         this.value = (BlockValue)MagicValues.key(PistonValue.class, value);
      }
   ...
   public void write(NetOutput out) throws IOException {
      ...
      if (this.type instanceof NoteBlockValueType) {
         type = (Integer)MagicValues.value(Integer.class, (NoteBlockValueType)this.type);
      } else if (this.type instanceof PistonValueType) {
         type = (Integer)MagicValues.value(Integer.class, (PistonValueType)this.type);
      } else if (this.type instanceof MobSpawnerValueType) {
         type = (Integer)MagicValues.value(Integer.class, (MobSpawnerValueType)this.type);
      } else if (this.type instanceof ChestValueType) {
         type = (Integer)MagicValues.value(Integer.class, (ChestValueType)this.type);
      } else if (this.type instanceof GenericBlockValueType) {
         type = (Integer)MagicValues.value(Integer.class, (GenericBlockValueType)this.type);
      }
      ...
      if (this.value instanceof NoteBlockValue) {
         ...
         val = (Integer)MagicValues.value(Integer.class, (PistonValue)this.value);
