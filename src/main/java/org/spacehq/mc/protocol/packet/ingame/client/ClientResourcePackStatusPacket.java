...
public class ClientResourcePackStatusPacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      ...
      this.status = (ResourcePackStatus)MagicValues.key(ResourcePackStatus.class, in.readVarInt());
   }

   public void write(NetOutput out) throws IOException {
      out.writeString(this.hash);
      out.writeVarInt((Integer)MagicValues.value(Integer.class, this.status));
   }
