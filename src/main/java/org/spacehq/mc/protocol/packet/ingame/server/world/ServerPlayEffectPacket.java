...
public class ServerPlayEffectPacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      int id = in.readInt();
      if (id >= 2000) {
         this.effect = (WorldEffect)MagicValues.key(ParticleEffect.class, id);
      } else {
         this.effect = (WorldEffect)MagicValues.key(SoundEffect.class, id);
      }
      ...
      if (this.effect == SoundEffect.PLAY_RECORD) {
         ...
         this.data = (WorldEffectData)MagicValues.key(SmokeEffectData.class, value);
   ...
   public void write(NetOutput out) throws IOException {
      ...
      if (this.effect instanceof ParticleEffect) {
         id = (Integer)MagicValues.value(Integer.class, (ParticleEffect)this.effect);
      } else if (this.effect instanceof SoundEffect) {
         id = (Integer)MagicValues.value(Integer.class, (SoundEffect)this.effect);
      }
      ...
      if (this.data instanceof RecordEffectData) {
         ...
         value = (Integer)MagicValues.value(Integer.class, (SmokeEffectData)this.data);
