...
public class ServerPlaySoundPacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      ...
      this.sound = (Sound)MagicValues.key(GenericSound.class, value);
      if (this.sound == null) {
         this.sound = new CustomSound(value);
      }

      this.x = (double)in.readInt() / 8.0D;
      this.y = (double)in.readInt() / 8.0D;
      this.z = (double)in.readInt() / 8.0D;
      this.volume = in.readFloat();
      this.pitch = (float)in.readUnsignedByte() / 63.0F;
   }
   ...
   public void write(NetOutput out) throws IOException {
      ...
      if (this.sound instanceof CustomSound) {
         ...
         value = (String)MagicValues.value(String.class, (GenericSound)this.sound);
      }

      out.writeString(value);
      out.writeInt((int)(this.x * 8.0D));
      out.writeInt((int)(this.y * 8.0D));
      out.writeInt((int)(this.z * 8.0D));
