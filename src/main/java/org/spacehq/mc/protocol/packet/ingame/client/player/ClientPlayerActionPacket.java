...
public class ClientPlayerActionPacket implements Packet {
   ...
   public void read(NetInput in) throws IOException {
      this.action = (PlayerAction)MagicValues.key(PlayerAction.class, in.readUnsignedByte());
      this.position = NetUtil.readPosition(in);
      this.face = (Face)MagicValues.key(Face.class, in.readUnsignedByte());
   }

   public void write(NetOutput out) throws IOException {
      out.writeByte((Integer)MagicValues.value(Integer.class, this.action));
      NetUtil.writePosition(out, this.position);
      out.writeByte((Integer)MagicValues.value(Integer.class, this.face));
   }
