...
public class MemoryHistory implements History {
   ...
   public ListIterator<History.Entry> entries(int index) {
      return new MemoryHistory.EntriesIterator(index - this.offset);
   }
   ...
   public String toString() {
      ...
      while(i$.hasNext()) {
         History.Entry e = (History.Entry)i$.next();
   ...
   private class EntriesIterator implements ListIterator<History.Entry> {
      ...
      public History.Entry next() {
         if (!this.source.hasNext()) {
            ...
            return new MemoryHistory.EntryImpl(MemoryHistory.this.offset + this.source.nextIndex(), (CharSequence)this.source.next());
         }
      }
      ...
      public History.Entry previous() {
         if (!this.source.hasPrevious()) {
            ...
            return new MemoryHistory.EntryImpl(MemoryHistory.this.offset + this.source.previousIndex(), (CharSequence)this.source.previous());
         }
      }
